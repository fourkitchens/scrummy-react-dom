...
test(
  "Game reducer is unchanged if action type not matched",
  reducerTest(game, {}, {}, {})
);
...
test(
  "Game reducer handles placeVote",
  reducerTest(
    game,
    { nickname: "flip", votes: {} },
...
test(
  "Game reducer handles placeVote with existing vote",
  reducerTest(
    game,
...
test(
  "Game reducer handles youSignedIn",
  reducerTest(
    game,
...
test(
  "Game reducer handles someoneSignedIn",
  reducerTest(
    game,
...
test(
  "Game reducer handles someoneVoted",
  reducerTest(
    game,
    { nickname: "flip", votes: { flip: "5" } },
    {
...
test(
  "Game reducer handles clientRevoke",
  reducerTest(
    game,
    { nickname: "flip", votes: { flip: "5", luke: "13" } },
    {
...
test(
  "Game reducer handles clientDisconnect",
  reducerTest(
    game,
    {
      nickname: "Jess",
      users: [{ nickname: "Jess" }, { nickname: "Coach" }, { nickname: "Tran" }]
    },
    {
